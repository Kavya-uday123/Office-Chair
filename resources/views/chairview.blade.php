...
<br>
    <div class="container">
        <div class="row">
            ...
            <h2 align="center" style="color:grey">View Chairs</h2>
    ...
    <tr>
        ...
        <td><?php  echo $chair->chair_desc ?></td>
        <td><?php  echo $chair->chair_qty ?></td>
        <td><?php  echo $chair->chair_rate ?></td>
        <td><img src="..\Images\<?php  echo $chair->chair_img?>" height="100" width="100"></td>

        <td> <a class="btn btn-warning" href="/chairedit?editid=<?php echo $chair->chair_id ?>">Edit</a></td>
        <td> <a class="btn btn-warning" href="/chairedit/<?php echo $chair->chair_id ?>">Delete</a></td>
