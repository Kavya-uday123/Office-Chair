    ...
    foreach ($data1 as $row1){
        ...
        <div class="col-lg-6 col-lx-4">
          <div class="single_confirmation_details">
            ...
            <ul>
              <li>
                <p>order number</p><span>: <?php echo "100".$row1->billing_id?></span>
              </li>
              <li>
                <p>Name</p><span>:<?php  echo $row1->name?></span>
              </li>
              <li>
                <p>Contact</p><span>:<?php  echo $row1->contact?></span>
              </li>
              <li>
                <p>Email</p><span>:<?php  echo $row1->email?></span>
              </li>
              <li>
              ...
              <li>
                <p>Card</p><span>: <?php if(isset($rdbpay)){ echo $rdbpay;}?></span>
              </li>
              <li>
                <p>Your Card No:</p><span>: <?php if(isset($txtcardno)){ echo $txtcardno;}?></span>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-6 col-lx-4">
          <div class="single_confirmation_details">
            ...
            <li>
              ...
              <li>
                <p>postcode</p><span>: <?php  echo $row1->pincode?></span>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-6 col-lx-4">
          <div class="single_confirmation_details">
            ...
            <ul>
              <li>
                <p>Address</p><span>:<?php  echo $row1->shipping_add?></span>
              </li>
