                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/loginm">Admin</a>
                                </li>
                            </ul>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_product_item">
                                ...
                                <div class="single_product_text">
                                    <h4>Code : {{$chair->ccode}}</h4>
                                    <h3>Name : {{$chair->cname}}</h3>
                                    <h3>Description : {{$chair->cdes}}</h3>
                                    <h3>Quantity : {{$chair->cqty}}</h3>
                                    <h3>Rs : {{$chair->crate}}</h3>
                                    <a href="/cart" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-12">
                    <div class="best_product_slider owl-carousel">
                        <div class="single_product_item">
                            <img src="https://www.featherlitefurniture.com/drupal/sites/default/files/pictures/10_Anatom.png
" alt="">
                            <div class="single_product_text">
                                <h4>Anatom</h4>
                                <h3>Rs 1500</h3>
                        ...
                        <div class="single_product_item">
                            <img src="
https://www.featherlitefurniture.com/drupal/sites/default/files/pictures/12_Contact.png
" alt="">
                            <div class="single_product_text">
                                <h4>Contact</h4>
                                <h3>Rs 3500</h3>
